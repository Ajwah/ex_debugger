defmodule Support.EdgeCases.MultipleModules.SiblingsWithExDebugger do
  @moduledoc false
  use ExDebugger
  ...
  def run(ls, opts) do
    ...
    |> Enum.map(fn e ->
      opts
      |> Enum.reduce(e, fn
        {operator, amount}, a -> __MODULE__.Helpers.calculate(operator, a, amount)
...
defmodule Support.EdgeCases.MultipleModules.SiblingsWithExDebugger.Helpers do
  use ExDebugger
