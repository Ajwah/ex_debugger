defmodule EdgeCases.SingleDefCasesTest do
  ...
  @file_module_mappings %{
    ...
    SingleDefCases.ExpandedFormComplex.SingularArgument => "expanded_form_complex_singular_argument",
    SingleDefCases.ExpandedFormComplex.MultipleArgument => "expanded_form_complex_multiple_argument",
    ...
    SingleDefCases.ExpandedFormComplex.MultipleIndependentExpressions => "expanded_form_complex_multiple_independent_expressions",
  }
  ...
  describe "Single Def Cases: " do
    ...
    test "MultipleIndependentExpressions" do
      ...
      |> run_and_assert_match(15, 37, bindings: [{:inner_binding, {:multiplied_result, 40}}, {:inner_binding, {:result, 20}}])
    end
  end
        ...
        bindings: bindings
          |> Enum.reduce([], fn
            e, a when is_map(e) -> e = e
              ...
              a ++ e
            {:inner_binding, e}, a -> a ++ [e]
            e, a -> a ++ [e]
          end),
        env: %{
          file: "/Users/kevinjohnson/projects/ex_debugger/test/support/edge_cases/single_def_cases/#{file_name}.ex",
